...
// include: C:\Users\gianc\AppData\Local\Temp\tmp0x7bad3y.js
...
(() => {
  ...
  loadPackage({
    "files": [ {
      "filename": "/textures/GUI/hotbar.png",
      "start": 0,
      "end": 1872
    }, {
      "filename": "/textures/GUI/hotbar_selection.png",
      "start": 1872,
      "end": 2318
    }, {
      "filename": "/textures/cobblestone.png",
      "start": 2318,
      "end": 3099
    }, {
      "filename": "/textures/dirt.png",
      "start": 3099,
      "end": 3299
    }, {
      "filename": "/textures/glass.png",
      "start": 3299,
      "end": 3483
    }, {
      "filename": "/textures/grass_block_side.png",
      "start": 3483,
      "end": 3891
    }, {
      "filename": "/textures/grass_block_top.png",
      "start": 3891,
      "end": 4189
    }, {
      "filename": "/textures/stone.png",
      "start": 4189,
      "end": 4412
    } ],
    "remote_package_size": 4412
  });
})();

// end include: C:\Users\gianc\AppData\Local\Temp\tmp0x7bad3y.js
// include: C:\Users\gianc\AppData\Local\Temp\tmp_1t_ms9q.js
...
// end include: C:\Users\gianc\AppData\Local\Temp\tmp_1t_ms9q.js
// include: C:\Users\gianc\AppData\Local\Temp\tmp3g2qr03y.js
...
// end include: C:\Users\gianc\AppData\Local\Temp\tmp3g2qr03y.js
var arguments_ = [];
...
function _emscripten_get_element_css_size(target, width, height) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(8, 0, 1, target, width, height);
...
function _emscripten_get_gamepad_status(index, gamepadState) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(9, 0, 1, index, gamepadState);
...
function _emscripten_request_pointerlock(target, deferUntilInEventHandler) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(11, 0, 1, target, deferUntilInEventHandler);
  target = findEventTarget(target);
  if (!target) return -4;
  if (!target.requestPointerLock) {
    return -1;
...
function _fd_seek(fd, offset, whence, newOffset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(33, 0, 1, fd, offset, whence, newOffset);
...
var ASM_CONSTS = {
  ...
  108716: () => Module.canvas.width,
  108748: () => parseInt(Module.canvas.style.width),
  108796: () => {
  ...
  109219: () => window.innerWidth,
  109245: () => window.innerHeight,
  109272: () => {
    if (document.fullscreenElement) return 1;
  },
  109318: () => Module.canvas.width,
  109350: () => parseInt(Module.canvas.style.width),
  109398: () => {
    if (document.fullscreenElement) return 1;
  },
  109444: () => Module.canvas.width,
  109476: () => screen.width,
  109501: () => window.innerWidth,
  109527: () => window.innerHeight,
  109554: () => {
    if (document.fullscreenElement) return 1;
  },
  109600: () => Module.canvas.width,
  109632: () => screen.width,
  109657: () => {
    document.exitFullscreen();
  },
  ...
  109730: () => Module.canvas.width,
  109762: () => parseInt(Module.canvas.style.width),
  109810: () => {
    document.exitFullscreen();
  },
  109837: $0 => {
  ...
  109875: () => screen.width,
  109900: () => screen.height,
  109926: () => window.screenX,
  109953: () => window.screenY,
  109980: () => window.devicePixelRatio,
  110016: $0 => {
  ...
  110557: () => window.innerWidth,
  110583: () => window.innerHeight
};
