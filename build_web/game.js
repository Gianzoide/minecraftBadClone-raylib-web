...
// include: C:\Users\gianc\AppData\Local\Temp\tmposzk5ffo.js
...
Module['FS_createPath']("/textures", "GUI", true, true);
    ...
    loadPackage({"files": [{"filename": "/textures/GUI/hotbar.png", "start": 0, "end": 1872}, {"filename": "/textures/GUI/hotbar_selection.png", "start": 1872, "end": 2318}, {"filename": "/textures/GUI/inventory.png", "start": 2318, "end": 3306}, {"filename": "/textures/atlas_0.png", "start": 3306, "end": 48236}, {"filename": "/textures/cobblestone.png", "start": 48236, "end": 49017}, {"filename": "/textures/dirt.png", "start": 49017, "end": 49217}, {"filename": "/textures/glass.png", "start": 49217, "end": 49401}, {"filename": "/textures/grass_block_side.png", "start": 49401, "end": 49809}, {"filename": "/textures/grass_block_top.png", "start": 49809, "end": 50506}, {"filename": "/textures/stone.png", "start": 50506, "end": 50729}], "remote_package_size": 50729});

  })();

// end include: C:\Users\gianc\AppData\Local\Temp\tmposzk5ffo.js
// include: C:\Users\gianc\AppData\Local\Temp\tmpcr43jcis.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\gianc\AppData\Local\Temp\tmpcr43jcis.js
// include: C:\Users\gianc\AppData\Local\Temp\tmpg5xj6ldz.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\gianc\AppData\Local\Temp\tmpg5xj6ldz.js
...
var ASM_CONSTS = {
  121742: () => { if (document.fullscreenElement) return 1; },  
 121788: () => { return Module.canvas.width; },  
 121820: () => { return parseInt(Module.canvas.style.width); },  
 121868: () => { document.exitFullscreen(); },  
 121895: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 121967: () => { if (document.fullscreenElement) return 1; },  
 122013: () => { return Module.canvas.width; },  
 122045: () => { return screen.width; },  
 122070: () => { document.exitFullscreen(); },  
 122097: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 122291: () => { return window.innerWidth; },  
 122317: () => { return window.innerHeight; },  
 122344: () => { if (document.fullscreenElement) return 1; },  
 122390: () => { return Module.canvas.width; },  
 122422: () => { return parseInt(Module.canvas.style.width); },  
 122470: () => { if (document.fullscreenElement) return 1; },  
 122516: () => { return Module.canvas.width; },  
 122548: () => { return screen.width; },  
 122573: () => { return window.innerWidth; },  
 122599: () => { return window.innerHeight; },  
 122626: () => { if (document.fullscreenElement) return 1; },  
 122672: () => { return Module.canvas.width; },  
 122704: () => { return screen.width; },  
 122729: () => { document.exitFullscreen(); },  
 122756: () => { if (document.fullscreenElement) return 1; },  
 122802: () => { return Module.canvas.width; },  
 122834: () => { return parseInt(Module.canvas.style.width); },  
 122882: () => { document.exitFullscreen(); },  
 122909: ($0) => { Module.canvas.style.opacity = $0; },  
 122947: () => { return screen.width; },  
 122972: () => { return screen.height; },  
 122998: () => { return window.screenX; },  
 123025: () => { return window.screenY; },  
 123052: () => { return window.devicePixelRatio; },  
 123088: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 123141: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 123192: () => { Module.canvas.style.cursor = 'none'; },  
 123229: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 123485: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 123536: () => { if (document.pointerLockElement) return 1; },  
 123583: () => { if (document.fullscreenElement) return 1; },  
 123629: () => { return window.innerWidth; },  
 123655: () => { return window.innerHeight; }
};
